    ...
    try:
        ...
        while doInfer:
            ...
            for obj in parsed_results:
                ...
                response = s3.put_object(ACL='public-read', Body=jpg_data.tostring(),Bucket='*************',Key=file_name)

                #img_url = 'https://s3.amazonaws.com/deeplens-image-captures/'+file_name
    
                label += '"{}": {:.2f}, "img_url":"{}"'.format(str(obj['label']), obj['prob'],file_name )
                label += '}'
